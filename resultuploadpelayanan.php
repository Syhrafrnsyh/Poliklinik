...
<body>
    ...
    echo "file orig name is ".$file_o_name.'<br>';*/
        if ($file_type == "application/pdf") {
            ...
            if ($upload) {
                $saveData = mysqli_query($con, "UPDATE book_pelayanan SET laporan='$server_path' WHERE id='$id' ") or die(mysqli_error($con));
				if ($saveData) {
                    echo '
                <script>
    ...
    ?>
		...
		<div class="container">
            <div class="row">
                <div class="col-12">
                    <h1>Result Upload Pelayanan</h1>

                    <div class="breadcrumbs">
                        <ul class="d-flex flex-wrap align-items-center p-0 m-0">
                            <li><a href="#">Home</a></li>
                            <li>Result Upload Pelayanan</li>
                        </ul>
                    </div><!-- .breadcrumbs -->
